<template>
  <div class="h-full flex flex-col">
    <div class="flex justify-between items-center mb-6">
      ...
      <div class="flex items-center space-x-2 text-sm text-slate-500 bg-slate-900 border border-slate-800 rounded-lg px-4 py-2">
        <span class="w-3 h-3 rounded-full bg-violet-500 block"></span><span class="mr-3">Synced</span>
      </div>
    </div>
